      ...
      <div className="container-fluid">
        ...
        <div className="container">
          <section>
            <h2>Overview:</h2>
            <p>
            {appname} is a project by Riya Projects located in the prime
            ...
            <p>
            {appname} is well thought plot in the strategic and thoughtful
              ...
              apartments. {appname} plot areas for its 1 BHK flat range from
              539 sq. ft. to 540 sq. ft. and 2 BHK flat areas range from 731 sq.
              ft. to 858 sq. ft. {appname} apartments are designed with
              ...
              and sanitary ware, and premium fixtures etc. {appname} provides
              ...
              and several more.
              <h2>Highpoints:</h2>
              {appname} is developed with a touch of Bengal which will give a
              ...
              can enjoy by having a walk around the property. {appname} has
              good connectivity and is 20 min from Barasat. {appname}
            ...
            <h2>About {appname}:</h2>
            <p>
              Located in Barrackpore, Kolkata, the {appname} is a
              thoughtfully planned one, equipped with all amenities for a
              comfortable living. The well-designed {appname} project is
              ...
              of the project is 01 May 2019. This world class {appname} has
              been granted. its commencement certificate. The occupancy
              certificate of this modern project not granted. {appname} has
              ...
              project is 700122. Relish the benefits of living in {appname},
              which offers all modern comforts.
            </p>
            <h2>{appname} Floor Plan:</h2>
            <p>
              To get an idea of the space covered, layout and room sizes, browsing
              through the floor plan would help. {appname} boasts of having 2
              ...
              differnt configurations across unit sizes of {appname} on
              Magicbricks.
            </p>
            <h2>{appname} Address:</h2>
            <p>
              The {appname} is strategically located at Barrackpore, Kolkata
              North, 700122.
            </p>
          </section>
        </div> 
