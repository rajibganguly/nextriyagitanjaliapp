      ...
      <div className="container-fluid">
        ...
        <div className="container">
          <section>
            ...
            <p>
              Riya Gitanjali is well thought plot in the strategic and thoughtful
              ...
              apartments. Riya Gitanjali plot areas for its 1 BHK flat range from
              539 sq. ft. to 540 sq. ft. and 2 BHK flat areas range from 731 sq.
              ft. to 858 sq. ft. Riya Gitanjali apartments are designed with
              ...
              and sanitary ware, and premium fixtures etc. Riya Gitanjali provides
              ...
              and several more.
              <h2>Highpoints:</h2>
              Riya Gitanjali is developed with a touch of Bengal which will give a
              ...
              can enjoy by having a walk around the property. Riya Gitanjali has
              good connectivity and is 20 min from Barasat. Riya Gitanjali
            ...
            <h2>About Riya Gitanjali:</h2>
            <p>
              Located in Barrackpore, Kolkata, the Riya Gitanjali is a
              thoughtfully planned one, equipped with all amenities for a
              comfortable living. The well-designed Riya Gitanjali project is
              ...
              of the project is 01 May 2019. This world class Riya Gitanjali has
              been granted. its commencement certificate. The occupancy
              certificate of this modern project not granted. Riya Gitanjali has
              ...
              project is 700122. Relish the benefits of living in Riya Gitanjali,
              which offers all modern comforts.
            </p>
            <h2>Riya Gitanjali Floor Plan:</h2>
            <p>
              To get an idea of the space covered, layout and room sizes, browsing
              through the floor plan would help. Riya Gitanjali boasts of having 2
              ...
              differnt configurations across unit sizes of Riya Gitanjali on
              Magicbricks.
            </p>
            <h2>Riya Gitanjali Address:</h2>
            <p>
              The Riya Gitanjali is strategically located at Barrackpore, Kolkata
              North, 700122.
            </p>
          </section>
        </div> 
